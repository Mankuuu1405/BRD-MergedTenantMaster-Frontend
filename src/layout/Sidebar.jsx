...
const items = [
  ...
  { path: "/audits", label: "Audit & Security", icon: ShieldCheckIcon },
  { path: "/tenant-reports", label: "Tenant Reports", icon: CalculatorIcon },
  { path: "/categories", label: "Categories", icon: Squares2X2Icon },
  { path: "/logs", label: "System Logs", icon: DocumentTextIcon },
  ...
  { section: "Advanced Tools" },
  {
    ...
    icon: UserCircleIcon,
    submenu: [
      { label: "Vendor Profile", path: "/vendor" },
